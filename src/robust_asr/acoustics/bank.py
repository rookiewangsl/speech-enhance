...
def generate_rir_bank(
    ...
    *,
    ...
    for room_index in range(rooms):
        ...
        for position_index, target_rt60 in enumerate(targets):
            scene_seed = room_seed + position_index + 1
            ...
            rir_id = f"{split}_r{room_index:03d}_p{position_index:03d}"
            ...
            rows.append(
                {
                    ...
                    "geometry_id": f"{rir_id}_geometry",
